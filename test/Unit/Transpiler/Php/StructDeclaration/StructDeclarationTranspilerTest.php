...
namespace PackageFactory\ComponentEngine\Test\Unit\Transpiler\Php\StructDeclaration;
...
final class StructDeclarationTranspilerTest extends TestCase
{
     ...
     * @return void
     */
    public function transpilesStructDeclarationNodes(): void
    {
        $structDeclarationAsString = <<<EOT
        struct Link {
            href: string
            target: string
        }
        ...
        $actualTranspilationResult = $structDeclarationTranspiler->transpile(
