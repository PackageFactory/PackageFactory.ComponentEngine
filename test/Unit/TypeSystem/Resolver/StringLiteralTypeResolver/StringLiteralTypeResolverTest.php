...
namespace PackageFactory\ComponentEngine\Test\Unit\TypeSystem\Resolver\StringLiteralTypeResolver;
...
final class StringLiteralTypeResolverTest extends TestCase
{
    /**
     * @test
     */
