...
final class ModuleTest extends TestCase
{
    ...
    public function happyPathProvider(): array
    {
        return [
            ...
            'expression assignment: const (brackets don\'t matter)' => [
                'const color = (0xFF0000)',
                [
                    [TokenType::MODULE_KEYWORD_CONST(), 'const'],
                    [TokenType::WHITESPACE(), ' '],
            ...
            'expression assignment: multiple const (brackets don\'t matter)' => [
                'const color = ( 0xFF0000 )' . PHP_EOL . 
                'const backgroundColor = (0x0000FF)',
                [
                    [TokenType::MODULE_KEYWORD_CONST(), 'const'],
            ...
            'expression assignment: export const (brackets don\'t matter)' => [
                'export const name = (("Jane Doe"))',
                [
                    [TokenType::MODULE_KEYWORD_EXPORT(), 'export'],
                    [TokenType::WHITESPACE(), ' '],
            ...
            'expression assignment: export default (brackets don\'t matter)' => [
                'export default ({ key: "foo", value: "bar" })',
                [
                    [TokenType::MODULE_KEYWORD_EXPORT(), 'export'],
                    [TokenType::WHITESPACE(), ' '],
            ...
            'afx assignment: const' => [
                ...
                [
                    ...
                    [TokenType::AFX_TAG_CONTENT(), 'Click'],
                    [TokenType::WHITESPACE(), ' '],
                    [TokenType::AFX_TAG_CONTENT(), 'here!'],
                    [TokenType::AFX_TAG_START(), '<'],
            ...
            'afx assignment: const (brackets don\'t matter)' => [
                'const Button = (<button>Click here!</button>)',
                [
                    [TokenType::MODULE_KEYWORD_CONST(), 'const'],
                    [TokenType::WHITESPACE(), ' '],
            ...
            'afx assignment: multiple const (brackets don\'t matter)' => [
                'const Button = (<button>Click here!</button>)' . PHP_EOL . 
                'const Headline = (<h1>Hello World!</h1>)',
                [
                    [TokenType::MODULE_KEYWORD_CONST(), 'const'],
            ...
            'afx assignment: export const (brackets don\'t matter)' => [
                'export const Option = (<option value={props.value}>{props.label}</option>)',
                [
                    [TokenType::MODULE_KEYWORD_EXPORT(), 'export'],
                    [TokenType::WHITESPACE(), ' '],
            ...
            'afx assignment: export default (brackets don\'t matter)' => [
                'export default (((<div>' . PHP_EOL . 
                '    <h1>Headline</h1>' . PHP_EOL .
                '    <div class={styles.content}>' . PHP_EOL .
                '        Some Content' . PHP_EOL .
            ...
            'import/export combined' => [
                'import Button from "./Button.afx"' . PHP_EOL .
                'export const foo = 4',
                [
                    [TokenType::MODULE_KEYWORD_IMPORT(), 'import'],
                    [TokenType::WHITESPACE(), ' '],
