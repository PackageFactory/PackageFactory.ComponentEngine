...
final class BlockScope extends Scope
{
    private function __construct(
        private readonly RecordType $knownSymbols
    ) {
    }

    public static function fromRecordType(RecordType $recordType): self
    {
        return new self($recordType);
    }

    public function lookupTypeOfValue(string $name): ?Type
    {
        return $this->knownSymbols->get($name)?->type;
    }
