...
use PackageFactory\ComponentEngine\TypeResolver\TypedAst\NumberLiteral;

trait ResolveNumberLiteral
{
    private function resolveNumberLiteral(
        NumberLiteralNode $numberLiteralNode
    ): NumberLiteral {
        return new NumberLiteral(
            format: $numberLiteralNode->format,
            value: $numberLiteralNode->value
        );
    }
}
