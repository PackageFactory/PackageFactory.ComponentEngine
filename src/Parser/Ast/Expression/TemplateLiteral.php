...
{
    /**
     * @var array<int,StringLiteral|Expression>
     */
    private readonly array $segments;

    private function __construct(
        StringLiteral|Expression ...$segments
    ) {
    ...
    public static function fromTokens(\Iterator $tokens): self
    {
        ...
        /** @var array<int,StringLiteral|Expression> $segments */
        $segments = [];

        while (true) {
            switch (Scanner::type($tokens)) {
                case TokenType::STRING_QUOTED:
                    $segments[] = StringLiteral::fromTokens($tokens);
                    break;
                case TokenType::DOLLAR:
                    ...
                    $segments[] = Expression::fromTokens($tokens);
