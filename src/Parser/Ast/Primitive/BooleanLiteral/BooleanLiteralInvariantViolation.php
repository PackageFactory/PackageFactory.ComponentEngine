...
namespace PackageFactory\ComponentEngine\Parser\Ast\Primitive\BooleanLiteral;

use PackageFactory\ComponentEngine\Parser\Tokenizer\Token;
use PackageFactory\ComponentEngine\Parser\Tokenizer\TokenType;

final class BooleanLiteralInvariantViolation extends \Exception
{
    ...
    {
        return new self(
            errorCode: 1648381968,
            errorMessage: sprintf(
                'Expected keyword "true" or "false", got "%s" instead.',
                $keyword
            )
        );
    }
