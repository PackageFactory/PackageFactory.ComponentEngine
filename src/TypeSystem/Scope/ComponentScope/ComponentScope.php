...
{
    public function __construct(private readonly ComponentDeclarationNode $componentDeclarationNode)
    {
    }
    ...
    private function resolveTypeReference(TypeReferenceNode $typeReferenceNode): TypeInterface
    {
